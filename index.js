...
<div id="image-music">
    <img src="${kkk.thumb}" style="width: 100%;  height: 100%;border-radius: 16px;border: 1.5px solid #0018ff;"></img>
       ...
       <div class="player">
            <button onclick="download()" class="btn-player">
...
mae = kkkk.map((kkk) => `
<audio controls>
	<source src="${kkk.url}" type="audio/mp3" fileName="${kkkk.title}.mp3">
	<source src="${kkkk.html}" type="audio/mp3" fileName="${kkkk.title}.mp3">
